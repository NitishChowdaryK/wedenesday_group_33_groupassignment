...
public class ConfigureABusiness {
    ...
    public static Business initialize() {
        ...
        employeeDirectory.newEmployeeProfile(new Person("Nitish"));
        employeeDirectory.newEmployeeProfile(new Person("Teja"));

        SalesPersonDirectory salesPersonDirectory = business.getSalesPersonDirectory();
        salesPersonDirectory.newSalesPersonProfile(new Person("Amruth"));

        MarketingPersonDirectory marketingPersonDirectory = business.getMarketingPersonDirectory();
        marketingPersonDirectory.newMarketingPersonProfile(new Person("Bhai"));
