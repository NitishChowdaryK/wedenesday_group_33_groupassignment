            ...
            for (Supplier supplier : this.getSupplierDirectory().getSupplierList()) {
                ...
                for (ProductSummary summary : productsReport.getProductSummaryList()) { // Assuming getProductSummaryList() exists
                    report.append("Product: ").append(summary.getSubjectProduct().toString()) // Assuming a method exists to get product name
                          .append(",Before the revenue: ").append(summary.getInitialRevenue()) // Update if necessary
                          .append(",After the revenue ").append(summary.getCurrentRevenue())   // Update if necessary
                          .append(", Sales Above Goal price: ").append(summary.getNumberAboveTarget())
                          .append(", Sales Below the Goal Price: ").append(summary.getNumberBelowTarget())
                          .append("\n");
                }
            }
